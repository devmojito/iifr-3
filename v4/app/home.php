...
<div class="iifr-hero">
    <div class="iifr-hero-bg" style="background-image:url('assets/images/faculty/Lamp%20Lighting.jpeg');"></div>
    <div class="iifr-hero-content">
        <div class="iifr-hero-label">Welcome to the International Institute of Faculty and Research (IIFR)</div>
        ...
        <div class="iifr-about__media">
            ...
            <div class="iifr-about__media-tag">
                ...
                <span style="display:flex;flex-direction:column;line-height:1.2;">
                    <span style="font-size:12px;color:rgba(255,255,255,0.7);text-transform:uppercase;letter-spacing:0.14em;">Established</span>
